...
> 当前状态：P1 主链路集成完成；完整回归 49/49，进入 P2 评估基线建设
...
- [x] 完成 01-04 基础 RAG 章节与实验
- [x] 完成 05-08 C++ 与检索算法章节与实验
- [x] 完成 09-11 生成、Agent、CLI 章节与实验
- [x] 完成 12-15 评估和预研章节与实验
- [x] 增加学习实验 smoke test 和 Markdown 链接校验
